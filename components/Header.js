...
function Header({placeholder}) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/* middle */}
      <div className="flex items-center md:border-2 rounded-full md:py-2 md:shadow-sm hover:shadow-md transition duration-150">
        <input
          values={searchInput}
          onChange={(e) => setSearchInput(e.target.value)}
          className="w-full rounded-full py-3 md:py-0 border-2 md:border-0 flex-grow pl-2 sm:pl-5 bg-transparent outline-none text-sm text-gray-600 palceholder-gray-400"
          type="text"
